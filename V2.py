...
class Block(nn.Module):
    ...
    def __init__(self, n_embd, n_head):
        ...
        self.ln1 = nn.LayerNorm(n_embd) # study and understand layer norms as they are used for further optimizations
        self.ln2 = nn.LayerNorm(n_embd)

    def forward(self, x):
        # we add x for residual connections:
        x = x + self.sa(self.ln1(x)) #encasing  x with layernorms for further optimization.
